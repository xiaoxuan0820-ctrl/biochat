...
<template>
  <DialogPortal>
    ...
    <DialogContent
      ...
      :class="cn(
        'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg data-[state=closed]:duration-200 data-[state=open]:duration-200 will-change-transform',
        side === 'right'
